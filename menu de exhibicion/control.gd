...
func _on_exhibition_1_pressed() -> void:
	...
	get_tree().change_scene_to_file("res://way/world.tscn")


func _on_exhibition_2_pressed() -> void:
	$button.play()
...
func _on_exhibition_4_pressed() -> void:
	$button.play()
	...
	# Después de que el fade esté completo, cambiar la escena
	get_tree().change_scene_to_file("res://carrera_1.tscn")


func _on_exhibition_3_pressed() -> void:
	get_tree().quit()
